...
const SportTabBar = ({
    ...
    return (
        <div className="mb-8">
            ...
            <div className="overflow-x-auto overscroll-x-contain pb-2 scrollbar-hide">
                <div className="mx-auto flex w-max min-w-full items-center justify-center gap-2 sm:mx-0 sm:min-w-0 sm:justify-start">
                    <motion.div
                        layout
