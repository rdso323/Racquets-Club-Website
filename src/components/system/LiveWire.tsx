...
const LiveWire = ({ dismissOnScroll = false, flipped = false }: LiveWireProps) => {
    ...
    return (
        <motion.div
            className="hairline-t hairline-b relative bg-court-950 py-3 dark:bg-court-950"
        ...
        >
            <VelocityMarquee
                ...
                copies={3}
            >
                <span className="inline-flex items-center gap-5 text-[11px] font-medium uppercase tracking-hud text-chalk/70">
                    <span className="text-court-accent">● Club Wire</span>
