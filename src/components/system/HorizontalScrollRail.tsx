...
const HorizontalScrollRail = ({
    ...
    const arrowButtonClass =
        'flex h-11 w-11 touch-manipulation items-center justify-center rounded-full border border-gray-200/90 bg-white/95 text-gray-700 shadow-lg backdrop-blur-sm transition-all hover:bg-white hover:scale-105 dark:border-chalk/15 dark:bg-carbon/95 dark:text-chalk/90 dark:hover:bg-carbon';
        ...
        <div className={`relative ${className}`}>
            ...
            {canScrollLeft && (
                <button
                    ...
                    className={`absolute left-1 top-[42%] z-20 -translate-y-1/2 ${arrowVisibility} ${arrowButtonClass}`}
            ...
            {(canScrollRight || showHint) && (
                <>
                    ...
                    <button
                        ...
                        className={`absolute right-2 top-[42%] z-20 -translate-y-1/2 ${arrowVisibility} ${arrowButtonClass} ${
