            ...
            <section className="px-4 md:px-8 mt-12 mb-20 max-w-7xl mx-auto flex">
                <div className="relative w-full rounded-3xl overflow-hidden min-h-[350px] flex items-center p-8 md:p-12 bg-gradient-to-br from-[#0e1320] via-[#0A0F1C] to-[#001A57] shadow-xl group">
                    ...
                    <div className="relative z-10 w-full max-w-4xl space-y-6 animate-fade-in">
                        ...
                        <p className="text-lg md:text-xl font-light text-blue-100/90 dark:text-gray-300 max-w-3xl leading-relaxed font-sans">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button
                                ...
                                className="forest-gradient px-8 py-4 rounded-xl text-white font-bold text-lg hover:scale-105 transition-all shadow-[0_20px_40px_rgba(0,0,0,0.4)] flex items-center justify-center gap-2 cursor-pointer"
                            >
                                Join Session
                            ...
                            <button
                                ...
                                className="text-white hover:text-gray-200 px-8 py-3 font-semibold transition-colors flex items-center justify-center cursor-pointer"
                            >
