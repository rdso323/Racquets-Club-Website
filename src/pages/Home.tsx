        ...
        <motion.main initial={false}>
            ...
            <section className="relative w-full overflow-hidden">
                <motion.div
                    ...
                    className="relative min-h-[88dvh] flex items-center bg-gradient-to-br from-emerald-50/70 via-[#F3F0E8] to-orange-50/40 dark:from-court-900 dark:via-court-950 dark:to-court-950"
                >
